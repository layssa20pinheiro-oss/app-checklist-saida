  ...
  return (
    <div className="min-h-screen bg-[#7e7f7f] p-4 flex flex-col items-center">
      ...
      <div className="mb-6 text-center">
         <img src="https://lh3.googleusercontent.com/d/1tsQYZ8c-dFBgDTK-xgWqyXQmLZy9ujji" alt="Logo" className="max-w-[150px] mx-auto" />
      </div>
        ...
        <div className="w-full max-w-md bg-white rounded-[30px] p-8 shadow-2xl">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input className="w-full border-b border-gray-200 py-2 outline-none" placeholder="Ex: Casamento Maria e João" onChange={e => setForm({...form, evento: e.target.value})} value={form.evento} />
            </div>
            
            <div>
              <label className="text-xs font-bold text-[#7e7f7f] uppercase">Local</label>
              <input className="w-full border-b border-gray-200 py-2 outline-none" placeholder="Nome do espaço" onChange={e => setForm({...form, local: e.target.value})} value={form.local} />
            </div>
            ...
            <div>
              <label className="text-xs font-bold text-[#7e7f7f] uppercase">O que estamos guardando?</label>
            ...
            <button onClick={() => setEtapa('resumo')} className="w-full bg-[#ded0b8] text-[#7e7f7f] font-bold py-4 rounded-2xl mt-4 shadow-lg active:scale-95 transition">
              GERAR ESBOÇO
            </button>
          </div>
        </div>
      ...
      {/* TELA DE RESUMO / PDF DESIGN */}
      {etapa === 'resumo' && (
        <div className="w-full flex flex-col items-center">
          <div ref={pdfRef} className="w-full max-w-md bg-[#7e7f7f] p-8 min-h-[600px] flex flex-col items-center">
            <img src="https://lh3.googleusercontent.com/d/1tsQYZ8c-dFBgDTK-xgWqyXQmLZy9ujji" className="max-w-[150px] mb-8" />
      ...
      {etapa === 'sucesso' && (
        <div className="w-full max-w-md bg-white rounded-[30px] p-10 shadow-2xl text-center">
          ...
          <div className="space-y-4">
            ...
            <button onClick={() => window.open(pdfUrl, '_blank')} className="w-full bg-[#4a90e2] text-white font-bold py-4 rounded-2xl flex items-center justify-center gap-2 shadow-lg"><FileDown size={20}/> VER RELATÓRIO OFICIAL</button>
