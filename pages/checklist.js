...
export default function ChecklistPage() {
  ...
  const salvarETerminar = async () => {
    setLoading(true);
    try {
      // Aqui está a sua correção do CORS para o Print funcionar!
      ...
      const dados = { ...form, itens, pdf_url: urlImg, foto_url: fotoUrl, evento_id: id };
    ...
    // Trava de segurança para parar de girar
    setLoading(false);
  };
  ...
  const enviarWhatsApp = () => {
    ...
    // Aqui está a sua correção do WhatsApp!
      ...
      {etapa === 'form' && (
        <div className="w-full max-w-md">
          ...
          <div className="flex flex-col items-center w-full mb-6 relative">
            <img src="https://rticfwqptlxkpgawpzwf.supabase.co/storage/v1/object/public/fotos/logo.png" className="h-16 opacity-90 mb-4" alt="Logo Cerimonial" />
          ...
          <div className="bg-white rounded-[30px] p-8 shadow-xl relative">
